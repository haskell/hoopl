...
\simon{``Control-flow graph'' (hyphenated) should be consistent now.}
...
We will often abbreviate ``a node of type (@CmmNode@ @C@ @O@)''
...
We cannot simply return a @Graph@ for two reasons:
\begin{itemize}
...
\end{itemize}
Note that the result is a rewritten graph, regardless of whether @thing@ is a node, block, or graph.
