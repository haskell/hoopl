...
its own right.
\end{itemize}
A working prototype of \ourlib{} will soon be available for download 
at \url{http://ghc.cs.tufts.edu/hoopl}.
...
\ifpagetuning\vadjust{\penalty-10000 }\fi
 at the point of concatenation but also
...
input facts (the @FactBase@) and produces output facts. 
...
of the graphs at the point of concatenation.\finalremark{Why record the shapes?}
