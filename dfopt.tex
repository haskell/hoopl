...
The~code is mostly straightforward, although we try to be a clever
...
considering a forward analysis of this @Body@, where execution starts at~@L1@:
\begin{code}
  L1: x:=3; goto L4
  L2: x:=4; goto L4
...
The framework computes a fixed point of transfer functinos, and it is
up to the client of 
...
We~describe  two representatative
