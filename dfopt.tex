...
cmmAvailableVars g = zdfFpFacts soln
  where soln = zdfSolveFwd "available variables" availVarsLattice 
               avail_vars_transfer (fact_bot availVarsLattice) g
\end{code}%
\B
...
cmmLiveness g = zdfFpFacts soln
   where soln = zdfSolveBwd "liveness" liveLattice liveTransfers emptyVarSet g
\end{code}%
\B
