...
Analyses and transformations (the clients of the library)
are small, simple, and easy to get right.
The library itself
 is built around  % \ifpagetuning could be 'uses'
...
Our library defines representations of lattice operations,
control-flow graphs, transfer functions, and rewrite functions.
\emph{All} of these representations are polymorphic in the types of
...
In~addition to the representations listed above, the primary interface
to our dataflow library is a set of polymorphic functions that compute
...
To create a program transformation,
