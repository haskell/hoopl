...
examples of how types really helped us:
\begin{itemize}
\item 
...
parts of the code that cannot possibly interact except through
explicit function calls.
%%
%%An ancestor of \ourlib{} is in the Glasgow Haskell Compiler today,
%%in version~6.12.
With our new, superior design in hand, we are now moving back to
live-compiler mode,  pushing our vastly improved design into version
