...
each individual analysis and transformation keeps
track of the values of dataflow
facts; these facts are managed by
...
on~\lineref{solve.OO}
by a recursive call to @iter_OO@ (implementation not shown).
...
Function @anal_f_OO@ (implementation not shown) recursively calls
...
therefore no continuation analogous 
to @LOFsKont@.
...
% to think simple thoughts about classical code improvements.
\delendum{It would be good to give cross-refs to plces in the paper that
