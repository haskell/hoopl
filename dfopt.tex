...
data CmmNode e x where
  Head       :: CmmNode C O
  Assign     :: Reg -> Expr -> CmmNode O O
  Store      :: Expr -> Expr -> CmmNode O O
  Branch     :: BlockId -> CmmNode O C
  CondBranch :: BlockId -> BlockId -> CmmNode O C
  ...more constructors...
\end{code}
...
by giving the types of each of of its contructors.  For example, constructor @Head@
...
@L2@ the fact is (@x=7@, @y=4@, @z=True@).  Both blocks branch to @L3@
