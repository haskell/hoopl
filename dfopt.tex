...
The previous example was simple because the program consisted of straightline code;
dataflow analysis gets more complicated when programs have loops.
For example, 
consider this graph,
...
parameters may not be constants.
