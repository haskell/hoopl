...
or nothing is known about what the variable holds (bottom).
We~represent these facts using a finite map from variables to dataflow facts
(@HasConst@).
A variable with a constant value maps to @Just v@, where @v@ is the constant value;
