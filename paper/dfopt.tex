...
compiler writers.
How do we evaluate whether \hoopl\ fulfills this goal?

From a client's perspective,
the most important question is:
How easy is it to write an optimization using \hoopl?
\begin{itemize}
\item
One way to evaluate this question is by use cases.
...
Within GHC, \hoopl's API supports not only
...
\item
The API gives us great freedom to experiment with alternative implementations;
% there are possible alternative implementations;
