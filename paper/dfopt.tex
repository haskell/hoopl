...
This paper is a revised version of a submission to ICFP'10.
Please refer to the~version by
the four words in the footer after \textbf{MD5:}.\hspace*{-20pt}
}}
...
We can splice graphs together nicely, in constant time.
...
The elements of @FwdPass@ are, and must be,
polymorphic functions---\ourlib{} must use higher-rank types.
...
the result is the same as the first argument (the old fact), and
