...
\item 
Using a sophisticated algorithm which can be difficult to implement
\cite{lerner-grove-chambers:2002},
\ourlib\ \emph{interleaves} analysis and transformation.
We present a new implementation, which by exploiting generalized
algebraic data 
types
...
interleaves analyis and transformation with a degree of clarity and
...
\end{itemize}
%
\hoopl\ is designed for
imperative codes with arbitrary control flow, including intermediate
...
\simon{\ourlib\ provides a function
