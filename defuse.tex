...
\omithspagedef{delFromVarSet :: VarSet -> Var -> VarSet}{haskell.def.delFromVarSet}% context document
\hspagedef{DFM}{haskell.def.DFM}% context document
\hsfigdef{elemAvail}{haskell.def.elemAvail}% context figure
\omithspagedef{elemVarSet :: Var -> VarSet -> Bool}{haskell.def.elemVarSet}% context document
...
\omithspagedef{extendVarSet :: VarSet -> Var -> VarSet}{haskell.def.extendVarSet}% context document
...
\hsfigdef{fact\_name}{haskell.def.fact:unname}% context figure
\hsprelude{False}{Prelude}% context prelude
\hspagedef{ffp}{haskell.def.ffp}% context document
...
\hspagedef{fwd\_pure\_anal}{haskell.def.fwd:unpure:unanal}% context document
\hspagedef{gen}{haskell.def.gen}% context document
...
\hspagedef{kill}{haskell.def.kill}% context document
...
\hspagedefll{lattice}{haskell.def.lattice}% context document
...
\hsfigdefll[insertLateReloads.1]{result}{haskell.def.result}% context figure
...
\hspagedef{runWithoutFuel}{haskell.def.runWithoutFuel}% context document
...
\hsfigdefll[avail.solve.1]{soln}{haskell.def.soln}% context figure
\hsfigdef[solve.block]{solve\_block}{haskell.def.solve:unblock}% context figure
\hspagedef{solve\_blocks}{haskell.def.solve:unblocks}% context document
...
\hsfigdef[solve.Ox]{solve\_Ox}{haskell.def.solve:unOx}% context figure
...
\hspagedefll{transfers}{haskell.def.transfers}% context document
...
\nothspagedef{avail}{haskell.firstuse.avail}% used but not defined
\nothslinedef{Block}{haskell.firstuse.Block}% used but not defined
\nothspagedef{CmmLoad}{haskell.firstuse.CmmLoad}% used but not defined
\nothspagedef{CmmLocal}{haskell.firstuse.CmmLocal}% used but not defined
\nothspagedef{CmmReg}{haskell.firstuse.CmmReg}% used but not defined
\nothspagedef{Const}{haskell.firstuse.Const}% used but not defined
\nothslinedef{depth}{haskell.firstuse.depth}% used but not defined
\nothspagedef{emptyGraph}{haskell.firstuse.emptyGraph}% used but not defined
\nothspagedef{env}{haskell.firstuse.env}% used but not defined
\nothspagedef{filterVarsUsed}{haskell.firstuse.filterVarsUsed}% used but not defined
\nothspagedef{Graph}{haskell.firstuse.Graph}% used but not defined
\nothslinedef{in'}{haskell.firstuse.in'}% used but not defined
\nothspagedef{isStackSlot}{haskell.firstuse.isStackSlot}% used but not defined
\nothspagedef{isStackSlotOf}{haskell.firstuse.isStackSlotOf}% used but not defined
\nothspagedef{L2}{haskell.firstuse.L2}% used but not defined
\nothspagedef{Last}{haskell.firstuse.Last}% used but not defined
\nothspagedef{LastBranch}{haskell.firstuse.LastBranch}% used but not defined
\nothspagedef{LastCall}{haskell.firstuse.LastCall}% used but not defined
\nothspagedef{LastCondBranch}{haskell.firstuse.LastCondBranch}% used but not defined
\nothslinedef{LastNode}{haskell.firstuse.LastNode}% used but not defined
\nothslinedef{LastOutFacts}{haskell.firstuse.LastOutFacts}% used but not defined
\nothspagedef{LastSwitch}{haskell.firstuse.LastSwitch}% used but not defined
\nothspagedef{lim}{haskell.firstuse.lim}% used but not defined
\nothspagedef{live}{haskell.firstuse.live}% used but not defined
\nothslinedef{LocalVar}{haskell.firstuse.LocalVar}% used but not defined
\nothspagedef{map}{haskell.firstuse.map}% used but not defined
\nothspagedef{mid}{haskell.firstuse.mid}% used but not defined
\nothspagedef{MidAssign}{haskell.firstuse.MidAssign}% used but not defined
\nothspagedef{Middle}{haskell.firstuse.Middle}% used but not defined
\nothspagedef{MidStore}{haskell.firstuse.MidStore}% used but not defined
\nothslinedef{name}{haskell.firstuse.name}% used but not defined
\nothspagedef{node}{haskell.firstuse.node}% used but not defined
\nothspagedef{NoRewrite}{haskell.firstuse.NoRewrite}% used but not defined
\nothspagedef{RELOAD}{haskell.firstuse.RELOAD}% used but not defined
\nothspagedef{reload}{haskell.firstuse.reload}% used but not defined
\nothslinedef{solve\_OO}{haskell.firstuse.solve:unOO}% used but not defined
\nothspagedef{SPILL}{haskell.firstuse.SPILL}% used but not defined
\nothspagedef{Var}{haskell.firstuse.Var}% used but not defined
\nothspagedef{variableOfSlot}{haskell.firstuse.variableOfSlot}% used but not defined
\nothspagedef{vars}{haskell.firstuse.vars}% used but not defined
\nothspagedef{varSetToList}{haskell.firstuse.varSetToList}% used but not defined
\nothspagedef{zdfRewriteBwd}{haskell.firstuse.zdfRewriteBwd}% used but not defined
\nothspagedef{zdfSolveBwd}{haskell.firstuse.zdfSolveBwd}% used but not defined
